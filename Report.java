...
public class Report {
    ...
    public Report(int total, int active, int cancel, double expense) {
    ...
    public void displayInfo() {
        System.out.println("\n========== SUBSCRIPTION REPORT ==========");
        System.out.println("Total Subscriptions    : " + totalSubscription);
        System.out.println("Active Subscriptions   : " + activeSubscription);
        System.out.println("Cancelled Subscriptions: " + cancelledSubscription);
